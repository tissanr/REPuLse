...
const BUILTINS = [
  ...
  { label: "play",       type: "function", detail: "(play :name pattern) — start or replace a named track" },
  { label: "mute",       type: "function", detail: "(mute :name) — silence a track without removing it" },
  { label: "unmute",     type: "function", detail: "(unmute :name) — re-enable a muted track" },
  { label: "solo",       type: "function", detail: "(solo :name) — play only this track (mute all others)" },
  { label: "clear",      type: "function", detail: "(clear :name) — remove a track; (clear) removes all tracks" },
  { label: "tracks",     type: "function", detail: "(tracks) — list active track names" },
  { label: "tap",        type: "function", detail: "(tap) — register a BPM tap (4 taps sets tempo)" },
