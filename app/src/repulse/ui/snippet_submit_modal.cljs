  ...
  (let [overlay (js/document.createElement "div")]
    ...
    (set! (.-innerHTML overlay)
          (str "<div class=\"snippet-submit-modal\" id=\"snippet-submit-modal\">"
               ...
               "    <label for=\"ssm-tag-input\" class=\"ssm-label\">Tags</label>"
               ...
               "    <label for=\"ssm-code-preview\" class=\"ssm-label\">Code preview</label>"
               "    <pre id=\"ssm-code-preview\" class=\"ssm-code-preview\" tabindex=\"-1\"></pre>"
