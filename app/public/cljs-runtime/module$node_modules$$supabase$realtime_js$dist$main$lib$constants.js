shadow$provide.module$node_modules$$supabase$realtime_js$dist$main$lib$constants = function(global, require, module, exports) {
  ...
  exports.DEFAULT_VERSION = `realtime-js/${global.version}`;
  ...
  exports.CHANNEL_STATES = {closed:"closed", errored:"errored", joined:"joined", joining:"joining", leaving:"leaving"};
  exports.CHANNEL_EVENTS = {close:"phx_close", error:"phx_error", join:"phx_join", reply:"phx_reply", leave:"phx_leave", access_token:"access_token"};
  exports.TRANSPORTS = {websocket:"websocket"};
  exports.CONNECTION_STATE = {connecting:"connecting", open:"open", closing:"closing", closed:"closed"};
};
